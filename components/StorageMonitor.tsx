...
const StorageMonitor: React.FC = () => {
    ...
    return (
        <div className={`fixed bottom-0 right-10 z-[1500] bg-slate-900 border border-slate-700 rounded-t-lg shadow-2xl transition-all duration-300 w-80 font-mono text-[10px] flex flex-col ${isOpen ? 'h-64' : 'h-8'}`}>
